    ...
    <div className="p-4 md:p-6 space-y-6">
      ...
      <div className="border border-white/10 bg-[#0A0A0A] p-4">
        ...
        <div className="text-[10px] text-white/40 mt-3 leading-relaxed">
          ⚠ Reality: no client-side Lua obfuscator is unbreakable (Luraph included). If you sell the script,
          gate it behind Luarmor's server-side key check on top of this obfuscator for real protection.
        </div>
      </div>
    </div>
  );
